    ...
    <div className="page container" style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 20px' }}>
      ...
      <div style={{ color: 'var(--text-secondary)', lineHeight: 1.8 }}>
        ...
        <p style={{ marginBottom: '16px' }}>
          At ${platformName}, every contribution matters, and we want you to give with confidence. Donations are processed quickly and securely, and funds may go toward supporting the chosen cause shortly after a donation is made. <strong>Your donation goes directly toward the cause you choose to support.</strong>
        </p>
        <p style={{ marginBottom: '16px' }}>
