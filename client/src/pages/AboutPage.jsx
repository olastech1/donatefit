...
export default function AboutPage() {
  ...
  const defaultContent = `
    <div style="color: var(--text-secondary); line-height: 1.8; font-size: 1.05rem;">
      <p style="margin-bottom: 16px;">${platformName} is a transparent, secure, and user-centric crowdfunding platform designed to bridge the gap between people in need and those who want to help.</p>
      ...
      <p>Whether it's medical emergencies, educational funds, or community relief, ${platformName} provides the infrastructure to empower generosity globally.</p>
    </div>
  `;

  return (
    <div className="page container" style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 20px' }}>
      <h1 style={{ fontFamily: 'var(--font-display)', marginBottom: '24px', color: 'var(--text-primary)' }}>About {platformName}</h1>
      {loading ? (
