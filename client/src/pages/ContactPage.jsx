...
export default function ContactPage() {
  ...
  const defaultContent = `
    ...
    <div class="card" style="margin-bottom: 32px; padding: 32px;">
      ...
      <p style={{marginBottom: '12px'}}><strong>Email Support:</strong> support@altruwave.com</p>
      <p style={{marginBottom: '12px'}}><strong>Press & Media:</strong> press@altruwave.com</p>
