  ...
  return (
    <div className="home-page animate-fade">
      ...
      <section className="hero">
        <div className="container">
          ...
          <h1 className="animate-in" style={{ animationDelay: '0.2s' }}>
            ...
            <span className="gradient-text">waves of impact.</span>
          </h1>
          <p className="hero-subtitle animate-in" style={{ animationDelay: '0.3s' }}>
            AltruWave is a modern crowdfunding platform empowering meaningful causes built on transparency. 
      ...
      <section style={{ padding: '100px 0', textAlign: 'center', background: 'var(--gradient-sunset)', color: '#fff' }}>
        <div className="container">
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '2.5rem', fontWeight: 800, marginBottom: '20px', color: '#fff' }}>Ready to Make an Impact?</h2>
          <p style={{ fontSize: '1.1rem', opacity: 0.9, maxWidth: '600px', margin: '0 auto 32px' }}>
            Join thousands of donors and creators making a difference every day on AltruWave.
          </p>
