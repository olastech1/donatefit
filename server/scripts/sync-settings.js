...
const defaultSettings = [
  { key: 'platform_name', val: 'AltruWave', is_enc: false, desc: 'Display name of the platform' },
  { key: 'support_email', val: 'support@altruwave.com', is_enc: false, desc: 'Platform support email' },
  ...
  { key: 'smtp_from', val: 'AltruWave <noreply@altruwave.com>', is_enc: false, desc: 'Sender Name and Email' },
];
